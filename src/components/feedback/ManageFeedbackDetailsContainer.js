...
class ManageFeedbackDetailsContainer extends Component {
  constructor(props) {
    super(props);
...
ManageFeedbackDetailsContainer.propTypes = {
  actions: PropTypes.object.isRequired,
  candidates: PropTypes.array.isRequired,
  feedbackDetails: PropTypes.object.isRequired
};

ManageFeedbackDetailsContainer.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageFeedbackDetailsContainer);
